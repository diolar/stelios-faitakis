    ...
    <div>
      <fieldset>
        <div className="type-filters">
          {filters.map(({title, value, d, ...rest}) =>
            <label key={value} className="filter">
              ...
              <div className="filter__content">
                ...
                <span className="filter__title">{title[locale]}</span>
              </div>
            </label>
          )}
        </div>
      ...
      <div className="work-list">
        {cases &&
        cases.map(({ node: item }) => {
          const title = locale === 'en' ? item.frontmatter.titleEN : item.frontmatter.title;
          const hidden = type !== item.frontmatter.type;
          return (
            <article
              key={item.id}
              className="case"
            ...
            >
              <PreviewCompatibleImage
                imageInfo={{
                  ...
                  alt: `featured image thumbnail for case ${title}`,
                }}
              />
